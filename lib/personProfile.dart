...
import 'model/provider/gallary_page.dart';

class PersonProfilePage extends StatefulWidget {
  final String id;
  
  PersonProfilePage({this.id});
...
@override
  ...
  void initState() {
    ...
    apiRequests.getpersonprofile(widget.id).then((value) {
      print("---------------------------tiger---------------");
      print(value);
      setState(() {
        profile = value;
        ...
        return Scaffold(
          ...
          body:
                   ...
                   SingleChildScrollView(
                    child: isLoading?Center(child: CircularProgressIndicator(backgroundColor: Colors.teal,)):profile==null?
                    Align(
...
//                              ) ,
                    ...
                    widget.id.toString()!= _dataUser.getKey(Utility.ID)?  
                    GestureDetector(
                          onTap: () {
                            setState(() {
                              _isLoading=true;
...
// _showErrorDialog("succes");
                    ...
                    // });
                    //            Utility.showErrorDialog( AppLocalizations.of(context).lblerror, AppLocalizations.of(context).lblYouAreAlreadyFriend,DialogType.ERROR,context);
                       //       _showErrorDialog("انتم اصدقاء بالفعل ");
                            }
                          ...
                          child: Container(
                            ...
                            child: Text(profile.user.isFriend==1?AppLocalizations
                                .of(context)
                                .  lblcancelfriend: AppLocalizations
                                .of(context)
                                .  lblFriendRequest ,
                                style: TextStyle(
                                    fontFamily: "black" ,
